...
public class SaffuseFrameworkAPI extends SqlDBUtility {
	...
	public String method(String sCommand){
		...
		try{
			...
			case "getTitle":
				...
				stepDetails("Retrieving Title","Title: "+result+" Successfully retrieved.","Pass");
				break;
				
			case "getCurrentUrl":
				result=driver.getCurrentUrl();
				stepDetails("Retrieving Url","Url: "+result+" Successfully retrieved.","Pass");
				break;
			case "getPageSource":
			...
			case "quit":
				...
				break;
			default:
				System.out.println("Please provide correct command name.");
			}
		}
	...
	public boolean method(String sCommand,String sLocator){
		
		boolean result = false;
		try{
			switch(sCommand){
			case "isEnabled":
				result=getWebElement(sLocator).isEnabled();
				stepDetails("Verify Element is Enabled.","Element is Enabled successfully verified.","Pass");
				break;
			case "isSelected":
				result=getWebElement(sLocator).isSelected();
				stepDetails("Verify Element is Selected.","Element is Selected successfully verified.","Pass");
				break;
			case "isDisplayed":
				result=getWebElement(sLocator).isDisplayed();
				stepDetails("Verify Element is Displayed.","Element is Displayed successfully verified.","Pass");
				break;
			
			default:
				System.out.println("Please provide corrent command name.");
			}
