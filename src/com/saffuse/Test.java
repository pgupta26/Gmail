...
public class Test {
	...
	public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		//Child obj1=new Child();
		 ...
		 String dbName = "ImageCenterFileStore";
	     String serverip="FOSPANDEDB1";
		...
		// Establish the connection.
     	...
     	con = DriverManager.getConnection(url,"ImageCenterUser","ICUser@Connect"); 
...
*/
	...
	/*	Date date=new Date();
		...
		*/
		...
		driver.findElement(By.linkText("Selenium-Webdriver1")).click();
